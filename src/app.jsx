...
// Icons - simplified to avoid className issues
const MapPin = (props) => (
  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke={props.color || "currentColor"} strokeWidth="2">
...
const CheckCircle = (props) => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke={props.color || "currentColor"} strokeWidth="2">
